using PMSoft.TimingSchedulerServer;
...
namespace PMSoft.TimingSchedulerServer
{
	...
	public class Configuration
	{
		...
		private const string DefaultServiceName = "PMSoftTimingSchedulerServer";
		private const string DefaultServiceDisplayName = "PMSoftTimingSchedulerServer";
		private const string DefaultServiceDescription = "定时调度任务服务";
	    private static readonly string DefaultServerImplementationType = typeof(PMSoftTimingSchedulerServer).AssemblyQualifiedName;
