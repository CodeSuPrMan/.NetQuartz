...
{
    public class PMSoftTimingSchedulerServer : ServiceControl, ServiceSuspend
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PMSoftTimingSchedulerServer"/> class.
        /// </summary>
        public PMSoftTimingSchedulerServer()
        {
            logger = LogManager.GetLogger(GetType());
        }

        /// <summary>
        /// Initializes the instance of the <see cref="PMSoftTimingSchedulerServer"/> class.
        /// </summary>
